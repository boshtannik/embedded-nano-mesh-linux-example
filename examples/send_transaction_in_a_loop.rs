...
fn main() -> ! {
    ...
    loop {
        ...
        match mesh_node.send_with_transaction::<LinuxTime, LinuxSerial>(
            ...
            Ok(()) => {
                ufmt::uwriteln!(&mut LinuxSerial::default(), "Transaction done").unwrap();
            }
            Err(_) => ufmt::uwriteln!(&mut LinuxSerial::default(), "Transaction failed").unwrap(),
        }
